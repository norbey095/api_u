...
class UserDetailsServiceTest {
    ...
    void testLoadUserByUsername_UserFound() {
        String email = ConstantsInfTest.EMAIL;
    ...
    void testLoadUserByUsername_UserNotFound() {
        ...
        UsernameNotFoundException thrownException = assertThrows(
                ...
                ConstantsInfTest.USER_NOT_FOUND_POINTS+email
        );

        assertEquals(ConstantsInfTest.USER_NOT_FOUND_POINTS+email, thrownException.getMessage());
    }
}
