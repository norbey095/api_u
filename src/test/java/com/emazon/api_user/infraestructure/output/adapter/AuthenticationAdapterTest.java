...
class AuthenticationAdapterTest {
    ...
    /*@Test
    public void testGenerateExtraClaims() {
        Map<String, Object> claims = authenticationAdapter.generateExtraClaims(userAuth);

        assertNotNull(claims);
        assertEquals(ConstantsInfraestructure.ROLE + userAuth.getRole(), claims.get(ConstantsInfraestructure.AUTHORITIES));
    }*/
}
